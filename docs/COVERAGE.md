...
| R1 The grid drawn: the map in the listing              | 1, 3 | `render.listing.grid`, `render.gridLine`                             | `TestTheMapIsTheGridPrintedOnPageThree` -- held against the page-anchored distance, `TestTheMapMarksWhatPageOneSaysToMark` | done   |
| R1 The grid drawn: the map in the booklet              | 1, 3 | `render.fitMap`, `render.mapFit.hexCenter`, `render.Renderer.Booklet` | `TestTheDrawnMapIsTheGridPrintedOnPageThree` -- measured off the drawing, `TestEveryWorldIsDrawnInItsOwnHex`, `TestFitMapIsTheLargestDrawingThatFitsItsBox` -- the geometry retyped from the page               | done   |
| R1a The line drawn between the worlds a route joins    | 2    | `render.booklet.drawRoutes`                                           | `TestEveryRouteIsDrawn`                                                                                                    | done   |
| R2 World occurrence, one die at 4+, DM -1/0/+1 on the whole subsector | 1    | `gen.occurrenceTarget`, `gen.scan`                                    | `TestOccurrenceDMChangesTheStream`, `TestRejectsDMsTheBookDoesNotOffer`, `TestInvariantsOverManySeeds`                     | done   |
| R2a The occurrence DM on broad areas within a subsector | 1    | `starmap.Area`, `starmap.Grid.HoldAreas`, `gen.dmAt`, `cmd/ctworldgen.areaFlag`               | `TestAWholeGridAreaIsTheWholeGridDM`, `TestTheOccurrenceThrowIsOneDiePerHexInGridOrder`, `TestBroadAreasChangeWhereTheWorldsAre`, `TestParseArea`, `TestHoldAreasRefusesWhatErrataTwelveRefuses`, `TestBroadAreasReachBothDocuments` | done   |
...
| Rule                                                                       | Page   | Implementation                                                                                                                                                                                                                                                 | Test                                                                                                                                                                                                                                                                                                                                                                                                              | Status |
| -------------------------------------------------------------------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| R17 Dice engine, one and two dice, N+ targets                              | B1 2-3 | `dice.Stream.Die`/`D2`, `dice.Target`                                                                                                                                                                                                              | `TestDieIsOneDie`, `TestD2ConsumesTwoDiceInOrder`, `TestTargetIsNPlus`                                                                                                                                                                                                                                                                                                                     | done   |
| R18 The record and its provenance                                          | --     | `starmap.Record`, `starmap.World`, `starmap.Route`, `starmap.New`, `starmap.Decode`                                                                                                                                                                            | `TestNewRecordCarriesItsProvenance`, `TestGoldensValidate`, `TestDecodeRejectsUnknownFields`, `TestDecodeRejectsMoreThanOneDocument`, `TestDecodeDoesNotCallAMalformedTailASecondDocument`, `TestDecodeRejectsAHexOffTheRecordsGrid`, `TestDecodeRejectsARouteEndOffTheRecordsGrid`                                                                                                                               | done   |
...
| R24 A sector's documents: the sixteen sub-sectors, the ring, the index map | 1-4    | `render.member`, `render.members`, `render.listing.memberSection`, `render.listing.sectorIndex`, `render.indexMap`, `render.onMemberMap`, `render.memberWindow`, `render.window`, `booklet.memberPages`, `booklet.drawIndex`, `booklet.drawSeams`, `booklet.drawMemberNumbers` | `TestASectorsMemberMapsAreThePrintedGrid`, `TestASectorsMemberSectionsPartitionItsWorlds`, `TestACrossingLaneIsListedUnderBothItsSubsectors`, `TestTheBookletsMemberMapsAreTheGridPrintedOnPageThree`, `TestTheSectorIndexCarriesNoHexNumbers`, `TestTheSectorIndexNumbersItsSixteenBands`, `TestTheSectorIndexMapSeamsSitOnMemberBoundaries`, `TestTheSectorSliceGolden`                                                                                            | done   |
| R22 The referee's own notes, on a world and on the record                  | --     | `starmap.Record.Notes`, `starmap.World.Notes`, `render.bullets`, `render.listing.heading`                                                                                                                                                                     | `TestNotesRoundTripAndDoNotLoosenTheRecord`, `TestARecordWithNoNotesIsUnchanged`, `TestTheRefereesNotesReachBothDocuments`, `TestABookletDrawsTheCharactersAppleKeyboardsType`, `TestSplitMeasuresTheCharacterItWillDraw`                                                                                                                                                                                         | done   |
...
| E012    | What a broad area is, and how one is read against the throw         | `gen/gen.go`, `starmap/area.go`, `starmap/errors.go`, `starmap/record.go`     | records carrying at least one broad area     |
